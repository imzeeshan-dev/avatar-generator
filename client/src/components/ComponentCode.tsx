...
/>`
    return (
      <div>
        ...
        <p>
          To use Avatars in your React app, you need to install the package
          first. You can do it by running
        </p>
        <pre>
          <code>yarn add avatars</code>
        </pre>
        <p>or</p>
        <pre>
        ...
        <p>
          if you are using npm. Once you have avatars package installed, you
