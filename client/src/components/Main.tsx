...
export class Main extends React.Component<Props, State> {
  ...
  redirectToHome() {
    const path = '/login'
    const replace = true
    const navigate = <Navigate to={path} replace={replace} />
    return navigate
  }
  ...
  render() {
    ...
    const title = 'Avatars Generator - Generate your own avatars!'
        ...
        {!localStorage.getItem('user') ? (
          ...
          <main role='main'>
            ...
            <Helmet>
              ...
              <meta property='og:site_name' content='Avatars Generator' />
              <meta property='og:url' content={document.location.href} />
              <meta property='og:image' content={imageURL} />
              <meta
                property='og:description'
                content='Avatars Generator is a free online tool for generating your own avatar'
              />
